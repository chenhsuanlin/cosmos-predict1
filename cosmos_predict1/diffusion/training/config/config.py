...
from cosmos_predict1.diffusion.training.config.video2world_camera.registry import (
    register_configs as register_configs_video2world_camera,
)
...
def make_config():
    ...
    register_configs_video2world_camera()
    ...
    import_all_modules_from_package("cosmos_predict1.diffusion.training.config.video2world_camera", reload=True)
